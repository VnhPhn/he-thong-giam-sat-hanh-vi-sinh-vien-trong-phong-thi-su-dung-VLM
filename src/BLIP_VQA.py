...
# ⚙️ CẤU HÌNH
# ========================
CAM_URL = "http://172.16.15.0:4747/video"   # 👉 Thay IP điện thoại IP Webcam của bạn
DEVICE = "cuda" if torch.cuda.is_available() else "cpu"
LOG_DIR = "logs/evidence"
OFFLOAD_DIR = "D:/blip2_cache"   # nơi lưu phần model offload
...
print("🔹 Đang tải BLIP-2 Flan-T5-XL (tối ưu hóa cho RTX 3050)...")
blip_proc = Blip2Processor.from_pretrained("Salesforce/blip2-flan-t5-xl")
blip_model = Blip2ForConditionalGeneration.from_pretrained(
    "Salesforce/blip2-flan-t5-xl",
    torch_dtype=torch.float16,
    device_map="auto",            # chia tải GPU ↔ RAM
    low_cpu_mem_usage=True,       # giảm chiếm RAM
    offload_folder=OFFLOAD_DIR    # lưu phần model không đủ VRAM vào ổ D
)
...
def analyze_frame(frame, question):
    """Phân tích frame và trả lời câu hỏi bằng YOLO + BLIP-2."""
